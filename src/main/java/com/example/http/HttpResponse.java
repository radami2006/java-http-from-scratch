...
public class HttpResponse extends HttpMessage {
    ...
    public HttpStatusCodes getStatusCodes() {
        return statusCode;
    }

    public void setStatusCodes(HttpStatusCodes statusCode) {
    ...
    public static class Builder {
        ...
        public Builder statusCode(HttpStatusCodes statusCode) {
            response.setStatusCodes(statusCode);
            return this;
        }
